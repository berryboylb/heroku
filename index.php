...
<body>
    <h1 style='text-align: center; color: white;'>WELCOME TO HNGi7 GAMES THIS IS THE LEADERBOARD</h1>
      <div class='center'>
        <div class='top3'>
          <div class='two item'>
            <div class='pos'>
            ...
            <div class='name'>
              <?php echo $array[1]['full-name']; ?>
            </div>
            <div class='score'>
              <?php echo $array[1]['points']; ?>
            </div>
          </div>
          <div class='one item'>
            <div class='pos'>
            ...
            <div class='name'>
                <?php echo $array[0]['full-name']; ?>
            </div>
            <div class='score'>
              <?php echo $array[0]['points']; ?>
            </div>
          </div>
          <div class='three item'>
            ...
            <div class='name'>
                <?php echo $array[2]['full-name']; ?>
            </div>
            <div class='score'>
              <?php echo $array[2]['points']; ?>
            </div>
          </div>
        </div>
        <div class='list'>
          ...
          for ($i=3; $i < $num; $i++) { 
            ...
            <div class='name'>
                <?php echo $array[$i]['full-name']; ?>
            </div>
            <div class='score'>
              <?php echo $array[$i]['points']; ?>
            </div>
          </div>
          <?php
           } ?>
